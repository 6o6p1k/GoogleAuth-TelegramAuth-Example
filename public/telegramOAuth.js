(function(window) {
    ...
    (function(window){
        ...
        function initWidget(widgetEl) {
            ...
            if (widgetId = widgetEl.getAttribute('data-telegram-post')) {
            ...
            else if (widgetId = widgetEl.getAttribute('data-telegram-login')) {
                ...
                if (widgetEl.hasAttribute('data-init-auth')) {
                    src += '&init_auth=' + encodeURIComponent(widgetEl.getAttribute('data-init-auth'));
                }
                if (widgetEl.hasAttribute('data-request-access')) {
                    src += '&request_access=' + encodeURIComponent(widgetEl.getAttribute('data-request-access'));
                }
